...
%TCIDATA{LastRevised=Friday, November 23, 2001 17:33:12}
...
and 
\begin{equation}
{\cal A}\left( \varkappa +\delta \varkappa \right) =\sum_{0\leq m\leq \infty
}\delta ^{\left( m\right) }{\cal A}\left( \varkappa \right) =\sum_{0\leq
m\leq \infty }
\end{equation}%
...
\varkappa}\left( {\sf z},t\right) d{\sf z}dt=\int \left\{ \left. \delta
\varkappa \left( {\sf z},t\right) \frac{\delta {\cal L}\left( \varkappa ,%
\dot{\varkappa},t\right) }{\delta \dot{\varkappa}\left( {\sf z}\right) }%
\right| _{t_{i}}^{t_{f}}\right\} d{\sf z}-\int_{t_{i}}^{t_{f}}\frac{d}{dt}%
...
\left( {\sf z}\right) }\right\} d{\sf z}\delta \varkappa \left( {\sf z}%
,t\right) dt;\qquad \text{ }\delta \varkappa \left( t_{f}\right) =\delta
...
z}_{2}dt  \nonumber \\
&&\left. {}\right. \quad \quad \,=\frac{1}{2}\int_{t_{i}}^{t_{f}}\left\{ 
\frac{\delta ^{2}{\cal L}\left( {\cal \varkappa },{\cal \dot{\varkappa}}%
,t\right) }{\delta \varkappa \left( {\sf z}_{1}\right) \delta \varkappa
\left( {\sf z}_{2}\right) }\delta \varkappa \left( {\sf z}_{1},t\right)
\delta \varkappa \left( {\sf z}_{2},t\right) +2\frac{\delta ^{2}{\cal L}%
\left( {\cal \varkappa },{\cal \dot{\varkappa}},t\right) }{\delta \varkappa
\left( {\sf z}_{1}\right) \delta \dot{\varkappa}\left( {\sf z}_{2}\right) }%
\delta \varkappa \left( {\sf z}_{1},t\right) \delta \dot{\varkappa}\left( 
{\sf z}_{2},t\right) \right.  \nonumber \\
...
_{1},t\right) \delta \dot{\varkappa}\left( {\sf z}_{2},t\right) \right\} d%
{\sf z}_{1}d{\sf z}_{2}dt  \label{Avar2}
\end{eqnarray}%
...
\delta \dot{\varkappa}\left( {\sf z}_{2},t\right) \frac{\delta ^{2}{\cal L}%
\left( \varkappa ,\dot{\varkappa},t\right) }{\delta \varkappa \left( {\sf z}%
...
\label{Avar2a}
\end{eqnarray}%
$\lceil $It should be possible to remove the explicit dependence on $\delta 
\dot{\varkappa}$ in the second order variation of the action as we argued
that the value of $\dot{\varkappa}$ is determined by $\varkappa $ over the
...
_{2},t\right) d{\sf z}_{1}d{\sf z}_{2}dt=  \nonumber \\
&&\int \left\{ \left. \delta \dot{\varkappa}\left( {\sf z}_{1},t\right)
\delta \dot{\varkappa}\left( {\sf z}_{2},t\right) \frac{\delta ^{2}{\cal L}%
\left( {\cal \varkappa },{\cal \dot{\varkappa}},t\right) }{\delta \dot{%
\varkappa}\left( {\sf z}_{1}\right) \delta \dot{\varkappa}\left( {\sf z}%
...
_{2},t\right) d{\sf z}_{1}d{\sf z}_{2}dt
\end{eqnarray}%
Then it should be possible to obtain from this an expression that does not
contain $\delta \dot{\varkappa}$. However in the case we are dealing with
viz Lagrangians linear in the velocity eq. $\left( \ref{Avar2a}\right) $
does not contain any $\delta \dot{\varkappa}$ dependence as $\left\{ \frac{%
\delta ^{2}{\cal L}\left( \varkappa ,\dot{\varkappa},t\right) }{\delta \dot{%
\varkappa}\left( {\sf z}_{1}\right) \delta \dot{\varkappa}\left( {\sf z}%
_{2}\right) }\right\} =0\forall {\sf z}_{1},{\sf z}_{2}$ and thus 
\begin{equation}
\delta ^{\left( 2\right) }{\cal A}\left( \varkappa \right) =\frac{1}{2}%
\int_{t_{i}}^{t_{f}}\left\{ \left\{ \frac{\delta ^{2}{\cal L}\left( {\cal %
\varkappa },{\cal \dot{\varkappa}},t\right) }{\delta \varkappa \left( {\sf z}%
...
\end{equation}%
which gives necessary and sufficient conditions for stationary action.
...
\end{eqnarray}%
which is the condition for a positive semi definite integral kernel. In
order case this condition becomes 
\begin{equation}
...
{\sf z},t\right) \right\} $. Our Lagrangian is 
\begin{equation}
...
{\cal \varkappa }\left( t\right) \right) |\Psi \left( {\cal \varkappa }%
\left( t\right) \right) \right\rangle ^{-1}\left\{ \left\langle \Psi \left( 
...
\left( {\sf z}\right) }\right| \Psi \left( {\cal \varkappa }\left( t\right)
...
\end{eqnarray}%
The first derrivative is given by: 
\begin{eqnarray}
\frac{\delta {\cal \dot{A}}\left( \varkappa \left( t\right) \right) }{\delta
...
\end{eqnarray}%
$\lceil $after making the substitution 
\begin{equation}
...
\right) }\left\{ \frac{\delta {\cal T}\left( \varkappa \left( t\right)
\right) }{\delta \varkappa \left( {\sf z}_{1}\right) }-{\cal Z}\left( {\sf z}%
,t\right) \frac{\delta {\cal N}\left( \varkappa \left( t\right) \right) }{%
\delta \varkappa \left( {\sf z}_{1}\right) }\right\} 
\end{equation}%
where 
\begin{eqnarray}
\frac{\delta {\cal T}\left( \varkappa \left( {\sf z},t\right) \right) }{%
\delta \varkappa \left( {\sf z}_{1}\right) } &=&\frac{i}{2}\left\{
...
{\cal \varkappa }\left( {\sf z}\right) }\right| \frac{\delta \Psi \left( 
{\cal \varkappa }\left( t\right) \right) }{\delta {\cal \varkappa }\left( 
{\sf z}_{1}\right) }\right\rangle \right.  \\
...
\varkappa \left( {\sf z}_{1},t\right) \right) }{\delta \varkappa \left( {\sf %
z}\right) }=  \nonumber \\
...
t\right) \right) }{\delta \varkappa \left( {\sf z}\right) }=\frac{i}{2}%
\left\langle \Psi \left( {\cal \varkappa }\left( t\right) \right) |\Psi
\left( {\cal \varkappa }\left( t\right) \right) \right\rangle ^{-1}\times  
\nonumber \\
&&\left\{ \left\{ \left\langle \Psi \left( {\cal \varkappa }\left( t\right)
...
\right\} \times \right.   \nonumber \\
&&\times \left\{ \left\langle \Psi \left( {\cal \varkappa }\left( t\right)
\right) \left| \frac{\delta \Psi \left( {\cal \varkappa }\left( t\right)
...
\right| \Psi \left( {\cal \varkappa }\left( t\right) \right) \right\rangle
\right\} \times   \nonumber \\
&&\left. \times \left\{ \left\langle \Psi \left( {\cal \varkappa }\left(
...
&&-\left. \left\langle \left. \frac{\delta \Psi \left( {\cal \varkappa }%
\left( t\right) \right) }{\delta {\cal \varkappa }\left( {\sf z}\right) }%
\right| \Psi \left( {\cal \varkappa }\left( t\right) \right) \right\rangle
\left\langle \Psi \left( {\cal \varkappa }\left( t\right) \right) \left| 
\frac{\delta \Psi \left( {\cal \varkappa }\left( t\right) \right) }{\delta 
{\cal \varkappa }\left( {\sf z}_{1}\right) }\right. \right\rangle \right\}  
\nonumber \\
...
\nonumber \\
&&\left. \frac{-1}{{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }%
\left\langle \Psi \left( {\cal \varkappa }\left( t\right) \right) \left| 
\frac{\delta \Psi \left( {\cal \varkappa }\left( t\right) \right) }{\delta 
{\cal \varkappa }\left( {\sf z}\right) }\right. \right\rangle \left\langle
\left. \frac{\delta \Psi \left( {\cal \varkappa }\left( t\right) \right) }{%
...
\right) \right\rangle 
\end{equation}%
The second derrivative is given by: 
\begin{eqnarray}
\frac{\delta ^{2}{\cal \dot{A}}\left( \varkappa \left( t\right) \right) }{%
...
we will first consider eq. $\left( \ref{ha}\right) :$%
\begin{eqnarray}
\frac{\delta \eta \left( {\sf z}_{1},{\sf z},t\right) }{\delta \varkappa
\left( {\sf z}_{2}\right) } &=&\frac{\delta }{\delta \varkappa \left( {\sf z}%
_{2}\right) }\left\{ \frac{\delta {\cal Z}\left( {\sf z},t\right) }{\delta
\varkappa \left( {\sf z}_{1}\right) }-\frac{\delta {\cal Z}\left( {\sf z}%
_{1},t\right) }{\delta {\cal \varkappa }\left( {\sf z}\right) }\right\}  \\
&=&\frac{\delta ^{2}{\cal Z}\left( {\sf z},t\right) }{\delta \varkappa
\left( {\sf z}_{2}\right) \delta \varkappa \left( {\sf z}_{1}\right) }-\frac{%
\delta ^{2}{\cal Z}\left( {\sf z}_{1},t\right) }{\delta \varkappa \left( 
{\sf z}_{2}\right) \delta \varkappa \left( {\sf z}\right) }
\end{eqnarray}%
\begin{eqnarray}
&&\frac{\delta ^{2}{\cal Z}\left( {\sf z},t\right) }{\delta \varkappa \left( 
{\sf z}_{2}\right) \delta \varkappa \left( {\sf z}_{1}\right) }=\frac{\delta 
}{\delta \varkappa \left( {\sf z}_{2}\right) }\frac{1}{{\cal N}\left( {\cal %
\varkappa }\left( t\right) \right) }\left\{ \frac{\delta {\cal T}\left(
\varkappa \left( t\right) \right) }{\delta \varkappa \left( {\sf z}%
_{1}\right) }-{\cal Z}\left( {\sf z},t\right) \frac{\delta {\cal N}\left(
\varkappa \left( t\right) \right) }{\delta \varkappa \left( {\sf z}%
_{1}\right) }\right\} = \\
&&\frac{1}{{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }\left\{ 
\frac{\delta ^{2}{\cal T}\left( \varkappa \left( t\right) \right) }{\delta
\varkappa \left( {\sf z}_{2}\right) \delta \varkappa \left( {\sf z}%
_{1}\right) }-\frac{\delta {\cal Z}\left( {\sf z},t\right) }{\delta
\varkappa \left( {\sf z}_{2}\right) }\frac{\delta {\cal N}\left( \varkappa
\left( t\right) \right) }{\delta \varkappa \left( {\sf z}_{1}\right) }-{\cal %
Z}\left( {\sf z},t\right) \frac{\delta ^{2}{\cal N}\left( \varkappa \left(
t\right) \right) }{\delta \varkappa \left( {\sf z}_{2}\right) \delta
\varkappa \left( {\sf z}_{1}\right) }\right.  \\
&&\qquad \qquad \qquad \qquad \left. -\frac{1}{{\cal N}\left( {\cal %
\varkappa }\left( t\right) \right) }\left\{ \frac{\delta {\cal T}\left(
\varkappa \left( t\right) \right) }{\delta \varkappa \left( {\sf z}%
_{1}\right) }-{\cal Z}\left( {\sf z},t\right) \frac{\delta {\cal N}\left(
\varkappa \left( t\right) \right) }{\delta \varkappa \left( {\sf z}%
_{1}\right) }\right\} \frac{\delta {\cal N}\left( {\cal \varkappa }\left(
t\right) \right) }{\delta \varkappa \left( {\sf z}_{2}\right) }\right\}  \\
&=&\frac{1}{{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }\left\{ 
\frac{\delta ^{2}{\cal T}\left( \varkappa \left( t\right) \right) }{\delta
\varkappa \left( {\sf z}_{2}\right) \delta \varkappa \left( {\sf z}%
_{1}\right) }-\frac{\delta {\cal Z}\left( {\sf z},t\right) }{\delta
...
&&-\left. \frac{1}{{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }%
\frac{\delta {\cal Z}\left( {\sf z},t\right) }{\delta \varkappa \left( {\sf z%
}_{1}\right) }\frac{\delta {\cal N}\left( {\cal \varkappa }\left( t\right)
\right) }{\delta \varkappa \left( {\sf z}_{2}\right) }\right\}  \\
&\equiv &\frac{1}{{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }%
\left\{ {\frak K}\left( {\sf z}_{1},{\sf z}_{2}\right) -\frac{1}{{\cal N}%
\left( {\cal \varkappa }\left( t\right) \right) }\frac{\delta {\cal Z}\left( 
{\sf z},t\right) }{\delta \varkappa \left( {\sf z}_{1}\right) }\frac{\delta 
{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }{\delta \varkappa
\left( {\sf z}_{2}\right) }\right\}  \\
&\Rightarrow &\frac{\delta ^{2}{\cal Z}\left( {\sf z},t\right) }{\delta
\varkappa \left( {\sf z}_{2}\right) \delta \varkappa \left( {\sf z}%
_{1}\right) }-\frac{\delta ^{2}{\cal Z}\left( {\sf z}_{1},t\right) }{\delta
\varkappa \left( {\sf z}_{2}\right) \delta \varkappa \left( {\sf z}\right) }
\\
&=&\frac{1}{{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }\left\{ 
{\frak K}\left( {\sf z}_{1},{\sf z}_{2}\right) -{\frak K}\left( {\sf z},{\sf %
z}_{2}\right) -\frac{1}{{\cal N}\left( {\cal \varkappa }\left( t\right)
\right) }\frac{\delta {\cal Z}\left( {\sf z},t\right) }{\delta \varkappa
\left( {\sf z}_{1}\right) }\frac{\delta {\cal N}\left( {\cal \varkappa }%
\left( t\right) \right) }{\delta \varkappa \left( {\sf z}_{2}\right) }%
\right\} 
\end{eqnarray}%
\begin{eqnarray}
...
\delta \varkappa \left( {\sf z}_{2}\right) \delta \varkappa \left( {\sf z}%
_{1}\right) }-\frac{\delta {\cal E}\left( \varkappa \left( t\right) \right) 
}{\delta \varkappa \left( {\sf z}_{2}\right) }\frac{\delta {\cal N}\left(
\varkappa \left( t\right) \right) }{\delta \varkappa \left( {\sf z}%
_{1}\right) }-{\cal E}\left( {\cal \varkappa }\left( t\right) \right) \frac{%
...
_{1}\right) }\right.  \\
&&\left. -\frac{1}{{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }%
\frac{\delta {\cal E}\left( \varkappa \left( t\right) \right) }{\delta
\varkappa \left( {\sf z}_{1}\right) }\frac{\delta {\cal N}\left( \varkappa
\left( t\right) \right) }{\delta \varkappa \left( {\sf z}_{2}\right) }%
\right\}  \\
&\equiv &\frac{1}{{\cal N}\left( {\cal \varkappa }\left( t\right) \right) }%
\left\{ {\frak E}\left( {\sf z}_{1},{\sf z}_{2}\right) -\frac{1}{{\cal N}%
\left( {\cal \varkappa }\left( t\right) \right) }\frac{\delta {\cal E}\left(
\varkappa \left( t\right) \right) }{\delta \varkappa \left( {\sf z}%
