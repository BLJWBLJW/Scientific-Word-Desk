...
%TCIDATA{LastRevised=Thursday, August 13, 2026 10:42:13}
...
\begin{eqnarray}
P &=&P^{2} \\
P_{0}+\cdots +P_{2p} &=&\left( P_{0}+\cdots +P_{2r}\right) ^{2}
\end{eqnarray}%
\begin{equation}
c_{0}=\sum_{0\leq p\leq r}\sum_{1\leq j_{1}<\cdots <j_{2p}\leq
2p}c_{j_{1}\cdots j_{2p}}^{2}\gamma _{j_{1}}\cdots \gamma _{j_{2r}}
\end{equation}
\end{remark}
