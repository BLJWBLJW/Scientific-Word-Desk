...
%TCIDATA{LastRevised=Friday, November 05, 2004 09:33:49}
...
\end{align}
displaying that the derivatives wrt $\left\{  \left.  \alpha_pq\right\vert
...
^2,\bm{0}\right)  }{\partial\alpha_pq}\right\}  $ can also be expressed in
terms of the nonantisymmetric matrix $\mathbb{H}_2\left(  \bm{\varphi}\left(
\bm{\alpha}\right)  \right)  $ as
\begin{equation}
\frac{\partial\mathcal{E}\left(  \mathbb{D}^{2},\bm{0}\right)  }%
{\partial\alpha_{pq}}=-i\left(  \left[  \mathbb{D}^{1},\mathbb{H}_{1}\left(
...
\bibliography{agpopt,bw,coleman,DMF,yngve}
