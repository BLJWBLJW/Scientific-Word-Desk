...
%TCIDATA{LastRevised=Wednesday, October 10, 2018 09:40:19}
...
\emph{modular states. }If the state\emph{ }$f$ is modular then $\Phi
_{f}\left(  I_{\mathcal{A}}\right)  $ is modular for $\Pi_{f}\left(
...
(Type III representations of $w^{\ast}$-algebras) and physically as \emph{KMS
states are modular}.
...
The support, $\operatorname{Supp}\left\{  f\right\}  ,$ of a normal state $f$
is the smallest orthogonal projection, $P_{f}\in\mathcal{A}^{\prime\prime}$,
that has the property
\begin{equation}
f\left(  P_{f}\right)  =\operatorname{Tr}\left\{  \Pi_{f}\left(  P_{f}\right)
D_{f}\right\}  =1.
\end{equation}
...
One can show that
\begin{equation}
\operatorname{Supp}\left\{  f\right\}  =P_{f}=P_{\overline{\Pi_{f}\left(
\mathcal{A}\right)  ^{\prime\prime\prime}\Phi_{f}\left(  I_{\mathcal{A}%
}\right)  }}%
\end{equation}
...
$\lceil$The polar decomposition for any \emph{linear} operator, $A$, gives
\begin{equation}
\text{ }A=U\left\vert A\right\vert =U\left(  A^{\dagger}A\right)  ^{\frac
{1}{2}}=\left(  A^{\dagger}A\right)  ^{-\frac{1}{2}}U^{\dagger},
\end{equation}
...
T^{\dagger}\Phi_{f}\left(  I_{\mathcal{A}}\right)  ,\,T\in\Pi_{f}\left(
\mathcal{A}\right)  ^{\prime\prime\prime},
\end{equation}
...
\mathcal{A}\right)  ,\quad\Phi_{f}\left(  B_{1}\right)  \in\Phi_{f}\left(
\mathcal{A}\right)  ,\quad A\in\mathcal{L}^{CL}\left(  \mathcal{H}_{f}\right)
.
\end{equation}
...
}B\right)  }\right\}  =\sup\limits_{B\in\mathcal{H}_{f}}\left\{
\frac{f\left(  \left(  S_{f}\left(  B\right)  \right)  ^{\dagger}S_{f}\left(
B\right)  \right)  }{f\left(  B^{\dagger}B\right)  }\right\}  =\sup
\limits_{B\in\mathcal{H}_{f}}\left\{  \frac{f\left(  BB^{\dagger}\right)
}{f\left(  B^{\dagger}B\right)  }\right\}
\end{equation}
$\rfloor$
...
\right\rangle _{f}=\left\langle \left.  B_{1}\right\vert S_{f}^{\dagger}%
S_{f}\left(  B_{2}\right)  \right\rangle _{f}=\left\langle \left.
B_{1}^{\dagger}\right\vert S_{f}\left(  B_{2}\right)  \right\rangle
_{f}=f\left(  B_{1}B_{2}^{\dagger}\right)  =\left\langle \left.
B_{1}^{\dagger}\right\vert B_{2}^{\dagger}\right\rangle _{f}.\\
&  =f\left(  B_{1}^{\dagger}\left[  S_{f}^{\dagger}S_{f}\right]  \left(
B_{2}\right)  \right)  \ =\overline{f\left(  B_{2}B_{1}^{\dagger}\right)  }%
\end{align}
...
In general
\begin{equation}
\Pi_{f}\left(  \mathcal{A}\right)  \subset\mathcal{B}\left(  \mathcal{H}%
_{f}\right)  .
\end{equation}
...
\begin{equation}
u\left(  t\right)  =\left(  S_{f}^{\dagger}S_{f}\right)  ^{it}.
\end{equation}
...
$\widehat{\Delta^{it}}$ forms the modular group of $\Pi_{f}\left(
\mathcal{A}\right)  ^{\prime\prime}.$

The positive convex cone $\mathcal{H}_{f+}\subset\mathcal{H}_{f}$ is defined
by
\begin{equation}
\mathcal{H}_{f+}=\overline{\left\{  \left.  v\right\vert v=\mathcal{J}%
A\mathcal{J}A\Phi_{f}\left(  I_{\mathcal{A}}\right)  ,A\in\mathcal{A}\right\}
}.
\end{equation}
...
\item
\begin{equation}
A\mathcal{J}A\mathcal{H}_{f+}\subset\mathcal{H}_{f+}\forall A\in A\in\Pi
_{f}\left(  \mathcal{A}\right)  ^{\prime\prime}.
\end{equation}
...
\item
\begin{equation}
\mathcal{J}A\mathcal{J}=A^{\dagger}\forall A\in A\in\Pi_{f}\left(
\mathcal{A}\right)  ^{\prime\prime}\cap\Pi_{f}\left(  \mathcal{A}\right)
^{\prime\prime\prime}=\mathcal{C}\left(  \Pi_{f}\left(  \mathcal{A}\right)
^{\prime\prime}\right)  ,
\end{equation}
where $\mathcal{C}\left(  \Pi_{f}\left(  \mathcal{A}\right)  ^{\prime\prime
...
One of the key result in the theory of $w^{\ast}$-algebras is the following:
...
$=\left\langle \Phi_{\U{3c9} }\left(  I_{n}\right)  |\Pi_{\U{3c9} }\left(
A\right)  \Phi_{\U{3c9} }\left(  I_{n}\right)  \right\rangle _{\U{3c9}
_{\U{3c1} }}$. Moreover,%
\begin{equation}
...
I_{\mathcal{A}}\right)  ,
\end{equation}
and in particular $\left(  \omega\text{ is faithful }\right)  \Leftrightarrow
\left(  \Phi_{\U{3c9} }\left(  I_{\mathcal{A}}\right)  \text{ is separating
for }\Pi_{\omega}(\mathcal{A})\right)  \Leftrightarrow\left(  \Phi_{\U{3c9}
}\left(  I_{\mathcal{A}}\right)  \text{ is cyclic for }\Pi_{\omega
}(\mathcal{A})\right)  $.
\end{theorem}
...
\begin{equation}
\U{3c4} _{u}(A)=\Pi_{\omega}^{-1}(u\Pi_{\omega}(A)u^{\dagger})
\end{equation}
...
isomorphism $\Pi_{\U{3c9} _{\U{3c1} }}^{-1}$ exists.
...
\begin{equation}
c(AX)=c(\Pi_{\U{3c9} _{\U{3c1} }}(A)X)=\Pi_{\U{3c9} _{\U{3c1} }}%
(\mathcal{A})(c(X))=Ac(X).
\end{equation}
...
\end{align}%
\begin{align}
A_{I} &  =A_{Ip}-A_{\text{\textit{Im}}-}\\
A_{Ip} &  =\frac{1}{2}\left(  \left\vert A_{I}\right\vert +A_{I}\right)
=\frac{1}{4}\left(  \left\vert \left(  A-A^{\dagger}\right)  \right\vert
-i\left(  A-A^{\dagger}\right)  \right)  \\
A_{\text{\textit{Im}}-} &  =\frac{1}{2}\left(  \left\vert A_{I}\right\vert
...
\begin{align}
A_{R+}A_{R_{m}--} &  =0\\
A_{I+}A_{\text{\textit{Im}}-} &  =0.
\end{align}%
\begin{equation}
A=A_{Rp}-A_{R_{m}--}+i\left(  A_{Ip}-A_{\text{\textit{Im}}-}\right)  =\frac
{1}{2}\left\{  \left(  \left\vert A_{R}\right\vert +A_{R}\right)  -\left(
\left\vert A_{R}\right\vert -A_{R}\right)  +i\left(  \left(  \left\vert
A_{I}\right\vert +A_{I}\right)  -\left(  \left\vert A_{I}\right\vert
-A_{I}\right)  \right)  \right\}  .
\end{equation}
