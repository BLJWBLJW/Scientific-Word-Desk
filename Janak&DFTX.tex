...
%TCIDATA{LastRevised=Wednesday, June 29, 2005 12:45:14}
...
=\widehat{\Omega\left(  g\right)  }\left\vert \overset{}{a}\right)
=0,\label{roeig}%
\end{equation}
...
i.e. thay have some density in the region of space where the potential is
supported. 
...
\right)  \Phi\left(  \mathbf{x}^{\prime}\right)  ^{\dagger}\Phi\left(
\mathbf{x}^{\prime}\right)  \right]  \left[  \Phi\left(  \mathbf{x}\right)
^{\dagger}\Phi\left(  \mathbf{x}\right)  \Phi\left(  \mathbf{x}^{\prime
}\right)  ^{\dagger}\Phi\left(  \mathbf{x}^{\prime}\right)  \right]
=\nonumber\\
&  \Phi\left(  \mathbf{x}\right)  ^{\dagger}\Phi\left(  \mathbf{x}\right)
\Phi\left(  \mathbf{x}^{\prime}\right)  ^{\dagger}\Phi\left(  \mathbf{x}%
...
\Phi\left(  \mathbf{x}\right)  ^{\dagger}\Phi\left(  \mathbf{x}\right)
\Phi\left(  \mathbf{x}^{\prime}\right)  ^{\dagger}\Phi\left(  \mathbf{x}%
^{\prime}\right)  =\left[  \Phi\left(  \mathbf{x}\right)  ^{\dagger}%
\Phi\left(  \mathbf{x}\right)  \Phi\left(  \mathbf{x}^{\prime}\right)
^{\dagger}\Phi\left(  \mathbf{x}^{\prime}\right)  \right]  .
\end{align}
The dimension of these projections are given by
\begin{equation}
\operatorname{Tr}\left\{  \frac{1}{N}P_{N}\Phi\left(  \mathbf{x}\right)
^{\dagger}\Phi\left(  \mathbf{x}\right)  P_{N}\right\}  =\infty.
\end{equation}
