...
%TCIDATA{LastRevised=Friday, June 17, 2005 21:59:24}
...
\right.  \right\rangle ,
\end{equation}
where the universal energy, $E_{U}\left(  a\right)  ,$ of the state $a$ is
\begin{equation}
...
$\lceil$ The function $\Xi$ is neither surjective nor injective as
\begin{equation}
...
$. As $F\left(  x,y,z\right)  $ and $G\left(  x,y,z\right)  $ are level
surfaces
\begin{align}
...
\lambda\right)  }\right.  a\right)  }{\left(  \overset{}{a}\left\vert
a\right.  \right)  }-\left\langle \lambda\left\vert \overset{}{\gamma}\right.
\right\rangle .
\end{equation}
...
}\left(  \mathbb{R}^{3}\times\mathbb{C}\right)  \right\}  $ and $\left\{
\gamma\in L_{1}\left(  \mathbb{R}^{3}\times\mathbb{C}\right)  \right\}  .$ The
super operator action on $\mathcal{B}_{2sa}\left(  \mathcal{H}^{N}\right)  $
is defined by the semi bounded quadratic forms
\begin{align}
...
&  -\left.  \left\{  \left(  a\left\vert \left\{  \widehat{K+V_{2}}%
-\widehat{\Omega\left(  \lambda\right)  }\right\}  \right.  \Lambda
_{lm}\right)  -\mathfrak{L}\left(  a,\lambda\right)  \left(  a\left\vert
\overset{}{\Lambda_{lm}}\right.  \right)  \right\}  \left(  a\left\vert
\overset{}{\Lambda_{jk}}\right.  \right)  \right\} \nonumber\\
...
=r$ i.e. the map $D_{a}\Xi\left(  a_{0}\right)  $ is surjective \emph{and
}$\Xi\left(  a_{0}\right)  =\gamma$ then this point is regular \cite{Hestenes}%
. The tangent space $\mathcal{T}_{a_{0}}$ to this level surface at this point
is the space of vectors
\begin{equation}
\mathcal{T}_{a_{0}}=\left\{  h\left\vert \left(  h\left\vert \widehat{\Phi
_{j}^{\dagger}\Phi_{j}}\right.  a_{0}\right)  =0\right.  ;1\leq j\leq
r\right\}  =\ker\left\{  d\Xi\left(  a_{0}\right)  \right\}  ,
\end{equation}
which has dimension $\kappa\geq\left(  r_{N}^{2}-r\right)  ,$ clearly for
regular points
\begin{equation}
