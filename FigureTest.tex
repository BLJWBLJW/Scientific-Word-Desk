...
In fig's \ref{fig:graphs-first}, \ref{fig:graphs-second}, \ref{fig:plots-first} and figs \ref{fig:plots-second}%


\begin{figure}
\begin{center}
\subfigure{\label{fig:graphs-first}\includegraphics[width=85mm]{absorbed.eps}}

\\
\subfigure{\label{fig:graphs-second}\includegraphics[width=85mm]{reflected.eps}}
...
\subfigure{\label{fig:plots-first}\includegraphics[width=85mm]{indexofrefract.eps}}%
\end{center}
\\

\begin{center}
\subfigure{\label{fig:plots-second}\includegraphics[width=85mm]{impedance.eps}}%
\end{center}
\\
