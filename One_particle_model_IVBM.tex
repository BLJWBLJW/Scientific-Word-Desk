...
%TCIDATA{LastRevised=Friday, November 05, 2004 10:04:14}
...
on general $2N$-electron state are obtained.
...
In Appendix \ref{AGPFock} we further show that one can express the
...
\end{align}
displaying that the derivatives wrt $\left\{  \left.  \alpha_{p}q\right\vert
...
\bibitem {YellowBook}Linderberg,~J.;\ \ {\"O}rhn,~Y. \textit{Propagators in
